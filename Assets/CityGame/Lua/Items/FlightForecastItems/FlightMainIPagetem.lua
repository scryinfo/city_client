...
function FlightMainPageItem:initialize(viewRect, data)
    ...
    self.numText = self.viewRect:Find("rateText/numText"):GetComponent("Text")  --航班号
...
function FlightMainPageItem:initData(data)
    local trueWidth01 = self.rateText.preferredWidth
    self.rateText.rectTransform.sizeDelta = Vector2.New(trueWidth01, self.rateText.rectTransform.sizeDelta.y)
...
function FlightMainPageItem:Language()
    self.betMoneyText01.text = "累积投注："
    self.alreadyTranText02.text = "已下注"
end
--
