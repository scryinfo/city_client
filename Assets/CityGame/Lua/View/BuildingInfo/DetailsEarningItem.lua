...
function DetailsEarningItem:initialize(dataInfo, viewRect,id)
    ...
    self.head = viewTrans:Find("bg/headImage/head"):GetComponent("Image")  --Avatar
    self.headName = viewTrans:Find("bg/headImage/name"):GetComponent("Text")  --Avatar
    self.income = viewTrans:Find("bg/income"):GetComponent("Text")
    self.name = viewTrans:Find("bg/headImage/name")        --first name
    self.incomeText = viewTrans:Find("bg/incomeText"):GetComponent("Text")   --Amount of income
    self.picture = viewTrans:Find("bg/picture"):GetComponent("Image")         --image
    self.pictureText = viewTrans:Find("bg/picture/pictureText"):GetComponent("Text")   --Picture content
