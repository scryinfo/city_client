...
function ChooseLineItem:initialize(prefab,mgr,DataInfo,pos,allNumber)
    ...
    --TODO  fisher adds multilingual prompts
    ...
    if DataInfo.info.mId == nil then
        ...
        local bagCapacity = DataManager.GetBagCapacity()  --Total storage capacity
        self.warehouse_Slider.maxValue = bagCapacity
        n = DataManager.GetBagNum()      --Number of items in the warehouse
        self.spareCapacity = bagCapacity - n --The remaining capacity
        ...
        self.spareCapacity = PlayerBuildingBaseData[DataInfo.info.mId].storeCapacity - n --The remaining capacity
...
function ChooseLineItem:OnLinePanelBG(go)
    ...
    -- [[  Click to make it transportable
    go.manager:_onClick()
