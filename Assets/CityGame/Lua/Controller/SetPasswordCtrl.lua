...
function SetPasswordCtrl:initialize()
    UIPanel.initialize(self,UIType.Normal,UIMode.HideOther,UICollider.None)--You can go back and hide other panels after the UI is opened 
    --UIPanel.initialize(self,UIType.Normal,UIMode.NeedBack,UICollider.None)--You can go back, after the UI is opened, other UI is not hidden 
end
...
function SetPasswordCtrl:OnBack()
    PlayMusEff(1002)
    Event.Brocast("m_CanCleModeFyPwd")  --Cancel password change
    UIPanel.ClosePage()
end
