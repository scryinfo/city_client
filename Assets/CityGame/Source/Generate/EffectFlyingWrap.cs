...
public class EffectFlyingWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(EffectFlying), typeof(UnityEngine.MonoBehaviour));
	...
	static int Start(IntPtr L)
	{
		try
		{
			...
			EffectFlying obj = (EffectFlying)ToLua.CheckObject<EffectFlying>(L, 1);
			obj.Start();
			return 0;
		}
		catch (Exception e)
	...
	static int get_FromPos(IntPtr L)
	{
		...
		try
		{
			...
			EffectFlying obj = (EffectFlying)o;
