...
--生成itemPrefab(用于接收到回调后生成一个)
function BuildingBaseCtrl:RefreshCreateItem(dataInfo,itemPrefab,itemRoot,className,behaviour,instanceTable)
    if not dataInfo then
        return
    end
    local obj = BuildingBaseCtrl.loadingItemPrefab(itemPrefab,itemRoot)
