...
function MapRightGroundTransPage:initialize(viewRect)
    ...
    self.typeText = trans:Find("topRoot/bg/Text"):GetComponent("Text")  --Show whether to rent or sell
...
function MapRightGroundTransPage:refreshData(data)
    ...
    if data.detailData.groundState == GroundTransState.Sell then
        ...
        local data1 = {infoTypeStr = "Price", value = str}  --sale price
    ...
    elseif data.detailData.groundState == GroundTransState.Rent then
        ...
        local data1 = {infoTypeStr = "GroundRentTime", value = str1}  --Rental time
        ...
        local data2 = {infoTypeStr = "GroundRental", value = str2}  --rent
