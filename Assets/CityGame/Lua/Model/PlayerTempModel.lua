...
---Record player information temporarily
PlayerTempModel = {}
...
function PlayerTempModel.OnCreate()
    --Network callback registration The network calls back to the beginning of n
...
--Synchronization when creating buildings
...
--Get the building id of all buildings with warehouse
...
--Get how much capacity is left in the warehouse
...
--Get all buildings, according to buildingId
