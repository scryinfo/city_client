...
function CityInfoPanel.InitPanel()
    ...
    --right
    this.basicInfo = transform:Find("content/right/basicInfoBg")   --basic information
    ...
    this.level = transform:Find("content/right/basicInfoBg/topBg/developeBg/score/Text"):GetComponent("Text") --Technology Level
    ...
    this.volume = transform:Find("content/right/basicInfoBg/topBg/volumeBg/score/Text"):GetComponent("Text") --City transactions
    ...
    this.fundPool = transform:Find("content/right/basicInfoBg/topBg/fundBg/score/Text"):GetComponent("Text") --City bonus pool
    ...
    this.richBtn = transform:Find("content/right/basicInfoBg/topBg/richBg/downBg").gameObject      --City Ranking
    this.richText = transform:Find("content/right/basicInfoBg/topBg/richBg/downBg/Text"):GetComponent("Text")

    this.industryInfo = transform:Find("content/right/industryInfo")   --Industry Information

    this.industryBg = transform:Find("content/right/industryInfo/industryBg")   --Industry sales
    ...
    this.slide = transform:Find("content/right/industryInfo/industryBg/curveBg/curve"):GetComponent("Slide")  --slide
    this.graph = transform:Find("content/right/industryInfo/industryBg/curveBg/curve"):GetComponent("FunctionalGraph")  --Draw curve
    ...
    this.eva = transform:Find("content/right/industryInfo/oneContent/supplyDemandBg/eva")    --Eva level distribution
    ...
    this.oneContent = transform:Find("content/right/industryInfo/oneContent")          --First layer information
    ...
    this.supplyDemandBg = transform:Find("content/right/industryInfo/oneContent/supplyDemandBg")   --Industry supply and demand
    ...
    this.supplyDemandSlide = transform:Find("content/right/industryInfo/oneContent/supplyDemandBg/curveBg/curve"):GetComponent("Slide")  --slide
    this.supplyDemandGraph = transform:Find("content/right/industryInfo/oneContent/supplyDemandBg/curveBg/curve"):GetComponent("FunctionalGraph")  --Draw curve

    this.rankList = transform:Find("content/right/industryInfo/oneContent/rankList")   --Revenue ranking
    this.four = transform:Find("content/right/industryInfo/oneContent/rankList/four")   --4 column revenue ranking
    ...
    this.five = transform:Find("content/right/industryInfo/oneContent/rankList/five")   --Ranking of 5 revenues
    ...
    this.six = transform:Find("content/right/industryInfo/oneContent/rankList/six")  -- 6-column revenue ranking
    ...
    this.twoContent = transform:Find("content/right/industryInfo/oneContent/twoContent").gameObject 
    ...
    this.threeCurveBg = transform:Find("content/right/industryInfo/oneContent/twoContent/threeContent/threeContentBg/threecurve")  --Third layer curve
    ...
    this.threeSlide = transform:Find("content/right/industryInfo/oneContent/twoContent/threeContent/threeContentBg/threecurve/curveBg/curve"):GetComponent("Slide")  --slide
    this.threeGraph = transform:Find("content/right/industryInfo/oneContent/twoContent/threeContent/threeContentBg/threecurve/curveBg/curve"):GetComponent("FunctionalGraph")  --Draw curves

    this.threeRank = transform:Find("content/right/industryInfo/oneContent/twoContent/threeContent/threeContentBg/threeRank").gameObject   --Third level

    this.detailFive = transform:Find("content/right/industryInfo/oneContent/twoContent/threeContent/threeContentBg/threeRank/five").gameObject   ---5 detailed income ranking
    ...
    this.detailSix = transform:Find("content/right/industryInfo/oneContent/twoContent/threeContent/threeContentBg/threeRank/six").gameObject   --6 column detailed income ranking
