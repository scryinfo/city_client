...
public class City_MemoryStreamWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(City.MemoryStream), typeof(System.Object));
		...
		L.RegFunction("readBytesString", readBytesString);
		...
		L.RegFunction("New", _CreateCity_MemoryStream);
	...
	static int _CreateCity_MemoryStream(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				City.MemoryStream obj = new City.MemoryStream();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: City.MemoryStream.New");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int readBytesString(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	static int get_rpos(IntPtr L)
	{
		...
		try
		{
			...
			City.MemoryStream obj = (City.MemoryStream)o;
			int ret = obj.rpos;
