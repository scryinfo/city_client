...
function AddLineChooseItemPanel.InitPanel()
    ...
    this.leftBtn = transform:Find("leftBtn/leftBtn")
    this.leftDisableImg = transform:Find("leftBtn/disableImg")
    this.rightBtn = transform:Find("rightBtn/rightBtn"):GetComponent("Button")
    this.rightDisableImg = transform:Find("rightBtn/disableImg")
