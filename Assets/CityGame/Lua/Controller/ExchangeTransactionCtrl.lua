...
---是在hide还是refresh中处理？
ExchangeTransactionCtrl = class('ExchangeTransactionCtrl',UIPanel)
UIPanel:ResgisterOpen(ExchangeTransactionCtrl)
...
function ExchangeTransactionCtrl:_removeListeners()
    Event.RemoveListener("c_onExchangeChooseWareHouseBack", self._onExchangeChooseWareHouseBack, self)  --选择仓库完成
    Event.RemoveListener("c_onReceiveBuySellItemsInfo", self._updateItemTransactionData, self)
    Event.RemoveListener("c_onReceiveExchangeBuy", self._exchangeBuy, self)
    Event.RemoveListener("c_onReceiveExchangeSell", self._exchangeSell, self)
end
