...
function EvaJoinCtrl:Awake()
    ...
    transform:Find("EvaContentText1"):GetComponent("Text").text = GetLanguage(31010035)
    transform:Find("EvaText2"):GetComponent("Text").text = GetLanguage(23010002)
    transform:Find("EvaContentText2"):GetComponent("Text").text = GetLanguage(31010035)
    transform:Find("EvaText3"):GetComponent("Text").text = GetLanguage(23010003)
    transform:Find("EvaContentText3"):GetComponent("Text").text = GetLanguage(31010019)
    transform:Find("EvaText4"):GetComponent("Text").text = GetLanguage(23010004)
    transform:Find("EvaContentText4"):GetComponent("Text").text = GetLanguage(31010019)
    transform:Find("EvaText5"):GetComponent("Text").text = GetLanguage(23010005)
    transform:Find("EvaContentText5"):GetComponent("Text").text = GetLanguage(31010008)
    transform:Find("EvaText6"):GetComponent("Text").text = GetLanguage(23010006)
    transform:Find("EvaContentText6"):GetComponent("Text").text = GetLanguage(31010009)
