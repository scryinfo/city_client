...
function WarehousePanel.InitPanel()
    ...
    if transform:Find("Button/Sorting/List") then this.list = transform:Find("Button/Sorting/List").gameObject; end
    if transform:Find("Button/Sorting/List/nameBtn") then
