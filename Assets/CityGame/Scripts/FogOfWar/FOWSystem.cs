...
public class FOWSystem : MonoSingletons<FOWSystem>
{
	...
	static List<IFOWRevealer> mRevealers = new List<IFOWRevealer>();

	// Revealers that have been added since last update
	static List<IFOWRevealer> mAdded = new List<IFOWRevealer>();

	// Revealers that have been removed since last update
	static List<IFOWRevealer> mRemoved = new List<IFOWRevealer>();
