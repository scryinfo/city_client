...
function OpenHouseCtrl:_getComponent(go)
    ...
    self.effectText = go.transform:Find("root/salary/bg/bg01/effectText"):GetComponent("Text")  --Effect specific value
    self.effectExpWordText = go.transform:Find("root/salary/bg/bg01/Text01"):GetComponent("Text")  --Effect description
...
function OpenHouseCtrl:_initData()
    ...
    if self.m_data.info.salary ~= nil or self.m_data.info.salary == 0 then
        ...
        self:_showPercentValue(value)  --Wage ratio
    end
...
--Display data according to the selected gear
