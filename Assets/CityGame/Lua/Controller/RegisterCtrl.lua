...
function RegisterCtrl:Awake(go)
    ...
    registerBehaviour:AddClick(RegisterPanel.back,self.OnBack,self)  --Obtain
    registerBehaviour:AddClick(RegisterPanel.gain,self.OnGain,self)  --Obtain
    registerBehaviour:AddClick(RegisterPanel.register,self.OnRegister,self)  --register
    self.time = 60
